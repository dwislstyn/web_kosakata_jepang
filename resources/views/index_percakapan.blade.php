...
<body>
    <div class="d-flex flex-column flex-md-row" style="padding-bottom: 10px;">
        <div class="container index-kosakata">
            <div class="container">
                <p class="label-card-kosakata" style="margin-bottom:-1rem;">新説火 &nbsp; &nbsp; さっ たん</p>
            </div>

            <div class="container" style="margin-bottom: 3rem;">
                <p class="label-card-kosakata">Percakapan | Pelajaran {{ $bab }}</p>
            </div>
            
            <div class="container" style="text-align: center;">
                <p class="label-card-kosakata" style="margin-bottom: 0rem;">{{ $data->text_jepang }}</p>
                <p class="label-card-kosakata" style="margin-bottom: 0rem;">{{ $data->text_latin }}</p>
            </div>
                    ...
                    @foreach ($data->json_conversation as $listDialog)
                        ...
                        <div class="row card-dialog col-md-12 col-lg-12" style="{{ $justtifyContent }}">
                            ...
                            <div class="card-text-dialog">
                                ...
                                <p class="font-dialog">{{ $listDialog['text_jepang_indo'] }}</p>
                            </div>
